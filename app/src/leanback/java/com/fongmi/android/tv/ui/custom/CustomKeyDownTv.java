...
/**
 * 电视版手势 + D-pad 按键处理类
 * 合并手机版 CustomKeyDown 的手势能力与电视版 CustomKeyDownVod 的遥控器按键处理
 */
public class CustomKeyDownTv extends GestureDetector.SimpleOnGestureListener implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    public static CustomKeyDownTv create(Activity activity, View videoView) {
        return new CustomKeyDownTv(activity, videoView);
    }

    private CustomKeyDownTv(Activity activity, View videoView) {
    ...
    // ==================== Touch Gesture Handling (from CustomKeyDown) ====================
    ...
    // ==================== D-pad Key Handling (from CustomKeyDownVod) ====================
